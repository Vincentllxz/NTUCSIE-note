...
\begin{definition}
    ...
    \[
        \mathcal{N}(A) = (\mathcal{C}(A^{\T}))^{\perp}, \quad \text{ or } \quad \mathcal{C}(A) = (\mathcal{N}(A^{\T}))^{\perp}
    \]
\end{definition}
...
\begin{theorem}[3I Schwarz Inequality]
    ...
    \[
        |a^{\T} b| \leq \|\mathbf{a}\| \|\mathbf{b}\| \quad \text{ or } | \langle \mathbf{a}, \mathbf{b} \rangle | \leq \| \mathbf{a} \| \| \mathbf{b} \|
    \]
