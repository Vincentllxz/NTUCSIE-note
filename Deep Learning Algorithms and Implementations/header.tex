...
\newcommand{\Pad}[1]{\text{pad}\left( #1 \right)}
\newcommand{\Trans}[1]{\left( #1 \right)^{\top}}
\newcommand{\Iden}[1]{\mathcal{I}_{#1}}
\def\Pool{\text{pool}}
\def\BigO{\mathcal{O}}
...
% tikz
\usepackage{tikz}
\usetikzlibrary{intersections, angles, quotes, positioning, backgrounds, fit}
...
\declaretheoremstyle[
	...
	mdframed={
			...
			linecolor=ForestGreen, backgroundcolor=cyan!5,
			nobreak=false
		}
]{thmgreenbox}
...
\declaretheoremstyle[
	...
	mdframed={
			linewidth=2pt,
			rightline=false, topline=false, bottomline=false,
			linecolor=YellowOrange!80!black,
			nobreak=false
		}
]{thmorangeline}
...
\declaretheoremstyle[
	headfont=\bfseries\sffamily\color{Goldenrod!80!black}, bodyfont=\normalfont,
	mdframed={
			linewidth=2pt,
			rightline=false, topline=false, bottomline=false,
			linecolor=Goldenrod!80!black, backgroundcolor=Goldenrod!10,
			nobreak=false
		}
]{thmred3box}
...
\declaretheorem[style=conjpurplebox, name=Recall, numbered=no]{recall}
...
\renewenvironment{proof}[1][\proofname]{\par
	...
	\begin{mdframed}[linewidth=2pt,rightline=false, topline=false, bottomline=false,linecolor=RawSienna!70!black, backgroundcolor=RawSienna!1]
		}{%
...
\declaretheorem[style=thmorangeline, numbered=no, name=Remark]{remark}
\declaretheorem[style=thmblueline, numbered=no, name=Note]{note}
\declaretheorem[style=thmpinkbox, numbered=no, name=Question]{exercise}
...
\newcommand{\blue}[1]{\textcolor{cyan!70!black}{#1}}
