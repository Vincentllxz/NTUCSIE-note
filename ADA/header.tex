...
\setCJKmainfont{Kaiti TC}[AutoFakeBold=5.0]
...
% tikz
\usepackage{tikz}
\usetikzlibrary{intersections, angles, quotes, positioning, , decorations.pathreplacing, calc, fit, backgrounds, shapes}
...
\declaretheorem[style=conjpurplebox, name=Comment, numbered=no]{com}
\declaretheorem[style=conjpurplebox, name=Observation, numbered=no]{obs}
\declaretheorem[style=thmgreen3box, name=Recall, numbered=no]{recall}
\declaretheorem[style=thmredbox, name=Algorithm, numbered=no]{idea}
