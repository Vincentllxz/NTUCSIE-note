...
\begin{figure}[H]
    ...
    \node[state,accepting] (q_4) [right of=q_3] {$q_{4}$};    
      ...
      \path (q_1) edge[loop above] node {$0,1$} (q_1)
            ...
            (q_2) edge[above]  node {$0,\varepsilon$} (q_3)
...
\begin{definition}[Nondeterministic Finite Automata (NFA)]
    ...
    \begin{itemize}
        ...
        \item $\delta$: $Q \times \Sigma_{\varepsilon} \rightarrow P(Q)$
        \item $q_0 \in Q$
        \item $F \subset Q$
    \end{itemize}
\end{definition}
...
\begin{figure}[H]
    ...
    \begin{tikzpicture}[->, node distance=3cm, >=Stealth, on grid, auto]
        ...
        (q1) edge[bend right, left] node{$\varepsilon$} (q3)
...
\begin{itemize}
    ...
    \item Remove the states that not handle the $\varepsilon$ transition. For example, the start state
    \[
...
\begin{definition}
    \[
    E(\{ q_0 \}) = \{q_0\} \cup \{\text{states reached by $\varepsilon$ from $q_0$}\}
    \]
\end{definition}
...
\begin{itemize}
    ...
    \begin{figure}[H]
        ...
        \path (0) edge[below] node {$\varepsilon$} (01);
        \end{tikzpicture}
    \caption{$N_1 \cup N_2$}
    \end{figure}
    ...
    \begin{figure}[H]
        ...
        \path (4) edge[above] node {$\varepsilon$} (01);
        \path (5) edge[below] node {$\varepsilon$} (01);
        \end{tikzpicture}
        ...
        \begin{itemize}[label=$\circ$]
            ...
            \[
                \delta(q, a) = \begin{cases}
                    ...
                    \delta_2(q, a) & q \in Q_2 \\
                    \delta_1(q, \varepsilon) \cup \{ q_2 \} & q \in F_1, a = \varepsilon \\
                    \delta_1(q, \varepsilon)& q \in F_1, a \neq \varepsilon \\
                \end{cases}
            \]
            \item $q_0 = q_1$
            \item $F =F_2$
    ...
    \begin{figure}[H]
        ...
        \path (4) edge[bend right=35, above] node {$\varepsilon$} (1);
        \path (5) edge[bend left=35, below] node {$\varepsilon$} (1);
        \path (0) edge[above] node {$\varepsilon$} (1);
        \end{tikzpicture}
    \caption{$N_1^*$}
    \end{figure}
