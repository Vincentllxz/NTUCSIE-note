...
\]
\[
    s''_0(x_0) = 2c_0 = 0 \implies c_0 = 0, c_{n} = 0
\]
Solving $c_j,\ j = 0,1,\cdots,n$ using $(n+1)$ equalities: \ref{ajdiff} and the above boundary conditions. (with Thomas algorithm for banded linear system)
